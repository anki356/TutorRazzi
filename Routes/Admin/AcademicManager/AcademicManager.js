...
import { addAcademicManager, deleteManager, getAcademicManagerData, getAcademicManagerDetails, getAllAcademicManager, getTotalAcademicManager, updateManager } from '../../../controllers/Admin/AcademicManager/AcademicManager.js'
...
router.patch("/manager/:manager_id",authVerify,updateManager)
router.delete("/manager/:manager_id",authVerify,deleteManager)
