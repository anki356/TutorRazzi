...
console.log(moment(),moment.utc(classResponse.start_time,"YYYY-MM-DDTHH:mm:ss").utc(), moment.utc(classResponse.end_time,"YYYY-MM-DDTHH:mm:ss").utc())
    if (!(moment().isBetween(moment.utc(classResponse.start_time,"YYYY-MM-DDTHH:mm:ss"), moment.utc(classResponse.end_time,"YYYY-MM-DDTHH:mm:ss")))) {
